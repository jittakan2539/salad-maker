						...
						<section className="relative w-full flex flex-col items-center justify-center gap-3 px-10">
							...
							<div className="flex w-full gap-2 pt-10">
								...
								<button
									...
									className="flex w-1/2  items-center justify-center  bg-red-500 font-bold text-xl text-white p-4 rounded-xl hover:bg-red-600 hover:shadow-lg transition duration-300"
								>
									Delete
								</button>
							</div>
